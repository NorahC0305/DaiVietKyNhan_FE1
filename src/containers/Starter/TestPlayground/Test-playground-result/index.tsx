...
const TestPlaygroundResultPage = React.memo(() => {
  ...
  > = {
    PHLEGMATIC: {
      ...
      name: "SƠN TINH",
      image: "https://res.cloudinary.com/dauhpllo7/image/upload/v1763391991/S%C6%A1n_Tinh_4_bdwoat.png",
    ...
    SANGUINE: {
      ...
      title: "CHỬ ĐẠO TỔ",
      name: "CHỬ ĐỒNG TỬ",
      image: "https://res.cloudinary.com/dauhpllo7/image/upload/v1763391997/Ch%E1%BB%AD_%C4%91%E1%BB%93ng_t%E1%BB%AD_3_kaiglt.png",
    ...
    CHOLERIC: {
      ...
      name: "THÁNH GIÓNG",
      image: "https://res.cloudinary.com/dauhpllo7/image/upload/v1763391993/Th%C3%A1nh_Gi%C3%B3ng_3_rhekjv.png",
    ...
    MELANCHOLIC: {
      ...
      image: "https://res.cloudinary.com/dauhpllo7/image/upload/v1763391996/Li%E1%BB%85u_H%E1%BA%A1nh_3_pt13fc.png",
