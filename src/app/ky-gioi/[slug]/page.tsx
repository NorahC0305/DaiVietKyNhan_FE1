...
const phuTayHoScrollPositions: ScrollPosition[] = [
  ...
  { top: "46%", left: "14%", rotate: "-7deg" },
  { top: "50%", left: "24%", rotate: "-8deg" },
  { top: "30%", left: "28%", rotate: "-6deg" },
  { top: "20%", left: "38%", rotate: "-8deg" },
  { top: "24%", left: "46%", rotate: "-6deg" },
  { top: "38%", left: "58%", rotate: "-6deg" },
  { top: "58%", left: "56%", rotate: "-6deg" },
  { top: "68%", left: "60%", rotate: "-6deg" },
  { top: "58%", left: "68%", rotate: "-6deg" },
];
