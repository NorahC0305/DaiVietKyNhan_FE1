                            ...
                            <div className='relative lg:w-[900px] lg:h-[500px] w-[700px] h-[350px]'>
                                ...
                                <div className='absolute w-full h-[100%] flex items-center justify-center inset-0'>
                                    <div className='absolute lg:w-[70%] w-[60%] lg:h-[70%] h-[60%] flex flex-col justify-center'>
                                        ...
                                        <div className='flex items-center justify-center h-full inset-0 bg-[#C6BE9F] rounded-md'>
                                            <Textarea className='border-4 border-secondary !h-full rounded-md p-4 placeholder:text-gray-600 placeholder:text-sm placeholder:italic focus:outline-none focus:ring-0' placeholder='Hãy ghi những lời chia sẻ vào đây.....' />
                                        </div>
                                    </div>
                                </div>
                            </div>
